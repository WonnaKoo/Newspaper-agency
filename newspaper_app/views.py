...
def index(request):
    ...
    return render(request, "newspaper_app/index.html", context=context)
...
class TopicCreateView(LoginRequiredMixin, generic.CreateView):
    model = Topic
    fields = "__all__"
    success_url = reverse_lazy("newspaper_app:topic-list")
...
class NewspaperCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("newspaper_app:newspaper-list")
...
class RedactorExperienceUpdateView(LoginRequiredMixin, generic.UpdateView):
    ...
    success_url = reverse_lazy("newspaper_app:redactor-list")
...
def toggle_assign_to_newspaper(request, pk):
    ...
    return HttpResponseRedirect(
        reverse_lazy("newspaper_app:newspaper-detail", args=[pk])
    )


class RedactorUpdateDataView(LoginRequiredMixin, generic.UpdateView):
    model = Redactor
    template_name = "newspaper_app/redactor_update_data.html"
    form_class = RedactorUpdateDataForm

    def get_success_url(self):
        return reverse_lazy("newspaper_app:redactor-list")
